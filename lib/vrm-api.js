...
class VrmApiClient {
     ...
     * @param {function(number): Promise<void>} [sleepFn] adapter.setTimeout-based sleep.
     *   Inject this to avoid using Node.js global setTimeout in the library.
     *   Defaults to Promise-wrapped global setTimeout as fallback.
     */

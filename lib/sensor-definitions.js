...
// ─── Overall Stats keys (×4 periods = 28 states) ─────────────────────────────
// Keys match the two-letter codes returned in data.totals of the VRM stats API
// GET /installations/{id}/stats?type=kwh&interval=day
const OVERALL_STAT_KEYS = [
 { id: 'overall.pvToConsumers',      name: { en: 'PV Inverter → Consumers', de: 'PV-WR → Verbraucher' },      key: 'Pc', unit: 'kWh' },
 { id: 'overall.pvToBattery',        name: { en: 'PV Inverter → Battery',   de: 'PV-WR → Batterie' },        key: 'Pb', unit: 'kWh' },
 { id: 'overall.pvToGrid',           name: { en: 'PV Inverter → Grid',      de: 'PV-WR → Netz' },            key: 'Pg', unit: 'kWh' },
 { id: 'overall.gridToConsumers',    name: { en: 'Grid → Consumers',        de: 'Netz → Verbraucher' },      key: 'Gc', unit: 'kWh' },
 { id: 'overall.gridToBattery',      name: { en: 'Grid → Battery',          de: 'Netz → Batterie' },         key: 'Gb', unit: 'kWh' },
 { id: 'overall.batteryToConsumers', name: { en: 'Battery → Consumers',     de: 'Batterie → Verbraucher' },  key: 'Bc', unit: 'kWh' },
 { id: 'overall.batteryToGrid',      name: { en: 'Battery → Grid',          de: 'Batterie → Netz' },         key: 'Bg', unit: 'kWh' },
];

...
// ─── Overall Stats keys (×4 periods = 20 states) ─────────────────────────────
const OVERALL_STAT_KEYS = [
 { id: 'overall.batteriesPowerTotal', name: { en: 'Batteries Total Power', de: 'Batterien Gesamtleistung' }, key: 'vrm_batteries_power_total', unit: 'W' },
 { id: 'overall.pvInverterPowerTotal', name: { en: 'PV Inverter Total Power', de: 'PV-WR Gesamtleistung' }, key: 'vrm_pv_inverters_power_total', unit: 'W' },
 { id: 'overall.solarChargerPowerTotal', name: { en: 'Solar Charger Total Power', de: 'Solar Charger Gesamtleistung' }, key: 'vrm_solar_chargers_power_total', unit: 'W' },
 { id: 'overall.dcLoads', name: { en: 'DC Loads', de: 'DC-Lasten' }, key: 'vrm_dc_loads', unit: 'W' },
 { id: 'overall.totalSolarYield', name: { en: 'Total Solar Yield', de: 'PV Gesamtertrag' }, key: 'total_solar_yield', unit: 'kWh' },
 { id: 'overall.totalConsumption', name: { en: 'Total Consumption', de: 'Gesamtverbrauch' }, key: 'total_consumption', unit: 'kWh' },
 { id: 'overall.gridEnergyIn', name: { en: 'Grid Energy In', de: 'Netzbezug' }, key: 'grid_history_from', unit: 'kWh' },
 { id: 'overall.gridEnergyOut', name: { en: 'Grid Energy Out', de: 'Netzeinspeisung' }, key: 'grid_history_to', unit: 'kWh' },
];

const OVERALL_PERIODS = [
 { suffix: 'Today', label: { en: 'Today', de: 'Heute' } },
 { suffix: 'ThisWeek', label: { en: 'This Week', de: 'Diese Woche' } },
 { suffix: 'ThisMonth', label: { en: 'This Month', de: 'Dieser Monat' } },
 { suffix: 'ThisYear', label: { en: 'This Year', de: 'Dieses Jahr' } },
];
